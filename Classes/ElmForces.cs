...
namespace Classes
{
    public class ElmForces
    {
        public ElmForces ShallowCopy()
        {
            return (ElmForces)this.MemberwiseClone();
        }
        ...
        public double LLmax
        {
            get
            {
                return Math.Max(Truckmax * 1.25 + PLmax, 0.75 * Truckmax * 1.25 + Lanemax + PLmax);
            }
        }
